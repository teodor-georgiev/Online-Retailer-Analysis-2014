...
class Model_class(object):
    ...
    def neural_network(self, df_train:dict, df_test:dict, n_layers:int, n_nodes:int, dropout:list, activation:str, optimizer:str, loss:str, metrics:list, epochs:int, batch_size:int,verbose:int)->tuple:
        """
    ...
    def XY_split(self, df_train:dict, df_test:dict)->tuple:
        """ 
